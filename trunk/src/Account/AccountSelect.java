...
//#endif
    ...
    public AccountSelect(Display display, Displayable pView, boolean enableQuit,int status) {
        ...
        switch(status){
            ...
            case 1: str = "(chat)"; break;
            case 2: str = "(away)"; break;
            case 3: str = "(xa)"; break;
            case 4: str = "(dnd)"; break;
...
//#            addInCommand(1,cmdJabber); cmdJabber.setImg(0x90);
//#            addInCommand(1,cmdYaru); cmdYaru.setImg(0x91);
//#            addInCommand(1,cmdGTalk_SSL); cmdGTalk_SSL.setImg(0x92);
