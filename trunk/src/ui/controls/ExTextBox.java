...
//#ifdef ARCHIVE
	if (c==cmdPaste) { new ArchiveList(display, t, t.getCaretPosition(), 1, t,null); return true; }
//#endif
//#ifdef CLIPBOARD
//#         if (c==cmdPasteText) { insert(clipboard.getClipBoard(), t.getCaretPosition()); return true; }
//#endif
//#if TEMPLATES
